                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div>
                        ...
                        <div className="bg-muted/50 rounded-lg p-4 space-y-1">
                            ...
                            <DetailRow icon={Shield} label={T.ownership} value={T[equipment.ownership.toLowerCase()]} />
                    ...
                    <div>
                        ...
                        <div className="bg-muted/50 rounded-lg p-4 space-y-1">
                            <DetailRow icon={CheckCircle} label={T.assignedProject} value={project?.name || T.unassigned} />
                    ...
                    return (
                        ...
                        >
                            <div className="flex justify-between items-start">
                                ...
                                <span className={`px-2 py-1 text-xs font-semibold rounded-full ${item.ownership === 'Owned' ? 'bg-blue-100 text-blue-700' : 'bg-purple-100 text-purple-700'}`}>{T[item.ownership.toLowerCase()]}</span>
                            </div>
