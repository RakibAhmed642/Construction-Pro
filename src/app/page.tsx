      ...
      <div className="flex-1 flex flex-col h-screen overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-4 lg:p-10">
          <div className="w-full">
            ...
            {activeTab === 'finance' && <Finance transactions={transactions} projects={projects} clients={clients} employees={employees} onAdd={(data) => handleAdd('transactions', data)} onUpdate={(id, data) => handleUpdate('transactions', id, data)} onDelete={(id) => handleDelete('transactions', id)} onOpenModal={openModal} />}
